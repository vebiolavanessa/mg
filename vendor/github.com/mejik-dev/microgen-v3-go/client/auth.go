...
func (a *AuthClient) Login(body LoginParams) (*AuthResponse, *MicrogenError) {
...
func (a *AuthClient) Register(body RegisterParams) (*AuthResponse, *MicrogenError) {
...
func (a *AuthClient) User(opts ...*options.UserOptions) (*ProfileResponse, *MicrogenError) {
	query := ""
...
func (a *AuthClient) Update(body map[string]interface{}) (*ProfileResponse, *MicrogenError) {
...
func (a *AuthClient) Logout() (*AuthResponse, *MicrogenError) {
