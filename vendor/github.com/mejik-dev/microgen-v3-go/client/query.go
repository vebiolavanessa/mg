...
func (q *QueryClient) Find(opts ...*options.FindOptions) (*BulkResponse, *MicrogenError) {
	query := ""
...
func (q *QueryClient) GetByID(id string, opts ...*options.GetByIDOptions) (*SingleResponse, *MicrogenError) {
...
func (q *QueryClient) Create(body map[string]interface{}) (*SingleResponse, *MicrogenError) {
...
func (q *QueryClient) UpdateByID(id string, body map[string]interface{}) (*SingleResponse, *MicrogenError) {
...
func (q *QueryClient) DeleteByID(id string) (*SingleResponse, *MicrogenError) {
...
func (q *QueryClient) Link(id string, body map[string]interface{}) (*SingleResponse, *MicrogenError) {
...
func (q *QueryClient) Unlink(id string, body map[string]interface{}) (*SingleResponse, *MicrogenError) {
...
func (q *QueryClient) Count(opts ...*options.CountOptions) (*SingleResponse, *MicrogenError) {
	query := ""
